      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Đặt hàng</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Đặt hàng</h6>
        </nav>
          ...
          <div class="col-md-3">
            <a data-toggle="modal" data-target="#<?php echo $row['id']; ?>" class="custom-card">
              <div class="card mb-4 shadow-sm" style="display: inline-block">
                <img class="card-img-top" width="247px" height="247px" src="<?php echo "../assets/images/".$row['thumb_img'].""; ?>">
                <div class="card-body">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="container-fluid">
                    <form method="get" action="../admin/addcarrt.php">
                      <div class="row">
                        <div class="col-md-6">
                          <img src="<?php echo "../assets/images/".$row['thumb_img'].""; ?>" alt="<?php echo $row['id']; ?>" width="500" class="img-fluid" alt="Responsive image">
                        </div>
                        <div class="col-md-6">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <?php
                  ...
                  if($cart_query->num_rows > 0)
                    while($row0 = mysqli_fetch_assoc($cart_query)){ 
                      echo'
                        <tr>
                          <td><img src="../assets/images/'.$row0['thumb_img'].'" class="img-fluid" width="60"></td>
                          <th>'.$row0['name'].'</th>
          ...
          <div class="modal-footer">
            <form method="post" action="../admin/pay.php">
