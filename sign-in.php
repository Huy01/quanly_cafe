          ...
          <div class="row">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Tên người dùng" aria-label="username" aria-describedby="email-addon" name="username">
                    </div>
                    ...
                    <div class="text-center">
                      <button type="submit" name="loginBtn" class="btn bg-gradient-info w-100 mt-4 mb-0">Đăng nhập</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    Không có tài khoản?
                    <a href="sign-up.php" class="text-info text-gradient font-weight-bold">Đăng ký ngay</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('./assets/images/login_bg.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        if ($result->num_rows > 0) {
            while($row = mysqli_fetch_assoc($result)) {
              if ($row["account"] == $_POST['username']) { //Kiểm tra account
                if ($row ["password"] == md5($_POST['password'])) { //Kiểm tra password
